...
export const getServerSideProps = async ()=>{
    const productRes = await axios.get("https://eloquent-zabaione-3fdfec.netlify.app/api/products")
    const orderRes = await axios.get("https://eloquent-zabaione-3fdfec.netlify.app/api/orders")
